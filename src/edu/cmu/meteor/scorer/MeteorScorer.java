...
public class MeteorScorer {
	...
	public MeteorStats getMeteorStats(Alignment alignment) {
		...
		if (charBased) {
			...
			/*double[] testStageMatchesContent = new double[alignment.moduleContentMatches1
					.size()];
			double[] referenceStageMatchesContent = new double[alignment.moduleContentMatches1
					.size()];
			double[] testStageMatchesFunction = new double[alignment.moduleContentMatches1
					.size()];
			double[] referenceStageMatchesFunction = new double[alignment.moduleContentMatches1
			                .size()];*/
			...
			for (int i = 0; i < alignment.moduleContentMatches1.size(); i++) {
				stats.testStageMatchesContent.add((double) testStageMatchesContent[i]);
				stats.referenceStageMatchesContent
						.add((double) referenceStageMatchesContent[i]);
				stats.testStageMatchesFunction.add((double) testStageMatchesFunction[i]);
